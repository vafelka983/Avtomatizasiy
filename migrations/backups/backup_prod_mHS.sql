...
\restrict NN6VrpXrpxn6aLLT4R4P8WtnPvDgwiDuGaZDJt1JqwEQYrbYuHtKoCHYVnbPhIo
...
COPY public.boats (id, name, boat_type, displacement, build_date) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.fish_species_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.fishing_grounds_id_seq', 1, false);
...
\unrestrict NN6VrpXrpxn6aLLT4R4P8WtnPvDgwiDuGaZDJt1JqwEQYrbYuHtKoCHYVnbPhIo
